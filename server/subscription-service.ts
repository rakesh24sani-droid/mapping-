...
export const SUBSCRIPTION_PLANS: Record<PlanId, SubscriptionPlan> = {
  ...
  starter: {
    id: 'starter',
    name: 'STARTER',
    tagline: 'For emerging creators & podcast editors',
    priceMonthlyINR: 99,
    priceAnnualINR: 950,
    minutesPerMonth: 150,
    maxResolution: '1080p',
    ...
    watermark: false,
    features: [
      '150 processing minutes/month',
      '1080p Full HD Export',
      'No Watermark',
      'AI Auto-Reframe (3 styles)',
      'AI Captions & Subtitles',
      'Standard Processing Speed',
    ],
    featureHighlights: {
      minutes: '150 processing mins/mo',
  ...
  creator: {
    id: 'creator',
    name: 'CREATOR',
    tagline: 'Best for active YouTubers, podcasters & brands',
    priceMonthlyINR: 249,
    priceAnnualINR: 2390,
    minutesPerMonth: 500,
    maxResolution: '1080p',
    ...
    badge: '⭐ Most Popular',
    features: [
      '500 processing minutes/month',
      '1080p Full HD Studio Export',
      'No Watermark',
      'Advanced AI Clipping Engine',
      'AI Content Score Breakdown (Hook, Retention, Flow)',
      'AI Viral Titles & Hooks Suggestions',
      'Custom Brand Kit (Colors, Handles & Badges)',
      'Priority Processing Speed',
    ],
    featureHighlights: {
      minutes: '500 processing mins/mo',
      resolution: '1080p Full HD',
      watermark: 'No Watermark',
  ...
  pro: {
    id: 'pro',
    name: 'PRO',
    tagline: 'For professional agencies, studios & power creators',
    priceMonthlyINR: 699,
    priceAnnualINR: 6710,
    ...
    features: [
      ...
      '4K Ultra HD When Supported (and 1080p)',
      'No Watermark',
      'All Advanced AI Features Included',
      '1-Click Batch Generation of All Moments',
      'Multi-Language Captions (Hindi, Spanish, French, etc.)',
      'VIP Priority Processing (Ultra Fast)',
      'Unlimited Brand Kits & Export Presets',
    ],
    featureHighlights: {
